...
export default function TimesheetSettingsRedirectPage() {
  useEffect(() => {
        ...
        <Card className="max-w-md">
          <CardContent className="p-6 text-center">
            ...
            <p className="text-muted-foreground mb-4">
              Les paramètres des feuilles de temps ont été déplacés vers les paramètres d'organisation dans l'onglet Général.
            </p>
